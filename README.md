...
複数の技術スタックのサービス開発経験がありますが、サブ開発的な役割で簡単な修正ができる程度のスキルです。
...
外部から買収したサービスの運営、新規サービスの開発などで開発チームのリーダーを担当しています。

- 買収したサービスのインフラ移行作業
- AWS / Terraformを利用したインフラ運用
- Java(Play Framework) / Ruby(Rails)を使ったAPI開発
- Java(Play Framework)のRuby(Rails)移行作業
- React / Next.jsを使ったフロントエンド開発
...
- Swift、Kotlinを使った新規アプリ開発
    - メイン開発は外部の業務委託に依頼し、全体マネジメントや簡単な修正を担当していました
