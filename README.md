...
新規ネイティブアプリの開発においてPM、WEB開発(サーバーサイド・フロントエンド)を担当しました。
...
退職者の業務を引き継いでグループ認証基盤の新規開発を担当しました。
...
- Ruby on Railsを使ったWEBサービス、API開発
    - ほとんどの時期でPM兼開発者をしていました
- Swift、Kotlinを使った新規アプリ開発
    - 初期検証とプロトタイプ開発を実施
    - メイン開発は外部の業務委託に依頼し、マネジメントと簡単な修正を担当しました
- React Nativeを使った新規アプリ開発
    - 学生アルバイトと2人で新規アプリを開発しました
- 採用活動
    - エンジニア採用を担当。社員、業務委託を合わせて最大でも数人規模のチームです。
- プロダクトマネジメント
- 集客・SEO
- 外部広告の選定・導入・運用
...
求人県連の新規事業・子会社を立ち上げるにあたり、1人目のエンジニアとして開発等を担当しました。
