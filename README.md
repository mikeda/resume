...
最初の7年間は主にインフラエンジニアとして、SIとWEBサービス(ブログ、EC、ゲーム、ASP、不動産)の運用を経験しました。  
...
- Ruby(Rails)とTypeScript(Next.js)が最も得意です。
...
- ReactNative
    - 1年かけて学生アルバイトと2名で新規求人アプリを開発しました。
- Flutter
    - 開発プロジェクトにサーバーサイドエンジニアとして関わり、アプリの簡単な修正や機能追加を数回担当しました。
